...
//(et n'utilisera ni ses mains, ni une seule baguette en mode ninja)
//pour corser les choses, il y a ciné après, donc il faut etre rapide ! 
//ecrivez du code multithread pour finir les bols de chacun au plus vite
class RepasChinois
{
public :
	...
	const int nombreDeBouchee = 10; //nombre de bouchée que représente le plat de chacun
	//
	void MettreLaTable()
	{
