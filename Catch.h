...
#if defined(__CYGWIN__) || defined(__QNX__) || defined(__EMSCRIPTEN__) || defined(__DJGPP__) || defined(__ORBIS__)
...
namespace {
    ...
    bool useColourOnPlatform() {
        return
            ...
            !isDebuggerActive() &&
#endif
#if !(defined(__DJGPP__) && defined(__STRICT_ANSI__)) && !defined(__ORBIS__)
